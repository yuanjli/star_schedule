  ...
  <div class="container"> <!-- Container -->
    ...
    <div class="categories">
      <ul class="cat">
        <li>
          <ol class="type">
            <li><a href="#" data-filter="*" class="active">All types</a></li>
            <li><a href="#" data-filter=".a48">48-56 Charters</a></li>
            <li><a href="#" data-filter=".b24">24-34 Buses</a></li>
            <li><a href="#" data-filter=".c15">9-16 Vans</a></li>
          </ol>
        </li>
      </ul>
      <div class="clearfix"></div>
      ...
      <div class="portfolio-items">
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 a48">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/1DeluxeMotorCoach.jpg" title="Description: 56 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Deluxe Motor Coach</h4>
                <p>56 seats</p>
              </div>
              <img src="img/portfolio/1DeluxeMotorCoach.jpg" class="img-responsive" alt="Delux Motor Coach"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 a48">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/2luxuryCoach.jpg" title="Description: 48 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Luxury Coarch</h4>
                <p>48 Seats</p>
              </div>
              <img src="img/portfolio/2luxuryCoach.jpg" class="img-responsive" alt="Luxury Coach"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 a48">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/3Megabus.jpg" title="Description: 52 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Mega Bus</h4>
                <p>52 Seats</p>
              </div>
              <img src="img/portfolio/3Megabus.jpg" class="img-responsive" alt="Mega Bus"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 b24">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/4MiniBus.jpg" title="Description: 28 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Mini Bus</h4>
                <p>28 Seats</p>
              </div>
              <img src="img/portfolio/4MiniBus.jpg" class="img-responsive" alt="Mini Bus"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 b24">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/5schoolBus.jpg" title="Description: School Bus 32 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>School Bus</h4>
                <p>32 Seats</p>
              </div>
              <img src="img/portfolio/5schoolBus.jpg" class="img-responsive" alt="School Bus"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 b24">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/6Partybus.jpg" title="Description: 32 Seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Party Bus</h4>
                <p>32 Seats</p>
              </div>
              <img src="img/portfolio/6Partybus.jpg" class="img-responsive" alt="Party Bus"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 dapibus c15">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/7sprinterVan.jpg" title="Description: 16 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Sprinter</h4>
                <p>16 Seats</p>
              </div>
              <img src="img/portfolio/7sprinterVan.jpg" class="img-responsive" alt="Sprinter"> </a> </div>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 c15">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/8FordTransit.jpg" title="Description: 11 seats" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Ford Transit</h4>
                <p>11 seats</p>
              </div>
              <img src="img/portfolio/8FordTransit.jpg" class="img-responsive" alt="Ford Transit"> </a> </div>
          </div>
        </div>
      </div>
    </div>
...
<div id="about">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4"><img src="img/aboutpic.jpg" class="img-responsive"></div>
      <div class="col-md-4"><img src="img/aboutpic2.jpg" class="img-responsive"></div>
      <div class="col-md-4">
        <div class="about-text">
          <h4>Go Green!</h4>
